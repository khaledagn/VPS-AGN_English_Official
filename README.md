...
```
![logo](https://github.com/khaledagn/VPS-AGN_English_Official/blob/master/ALL-SCREEN/VPS-AGN.png)
...
rm -rf install-without-key.sh; apt update; apt upgrade -y; wget https://github.com/khaledagn/VPS-AGN_English_Official/raw/main/installer/install-without-key.sh; chmod 777 install-without-key.sh; ./install-without-key.sh --start
